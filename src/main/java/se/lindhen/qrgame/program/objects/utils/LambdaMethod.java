...
public class LambdaMethod<O extends ObjectValue> extends Method<O> {
    ...
    public LambdaMethod(String name, TriFunction<O, List<Expression>, Program, Object> function, FunctionDeclaration functionDeclaration) {
        super(name, functionDeclaration);
