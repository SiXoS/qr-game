...
public class TriangleFunction extends Function {
    ...
    public TriangleFunction() {
        super(NAME, new FunctionType(new ObjectType(ShapeClass.getQgClass()), NumberType.NUMBER_TYPE, NumberType.NUMBER_TYPE, NumberType.NUMBER_TYPE, NumberType.NUMBER_TYPE));
    }
